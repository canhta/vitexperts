...
const ServicesSingleMain = ({ firstAndSecondWord }: Props) => {
  return (
    <>
          ...
          <div className='row'>
            <div className='col-xl-12'>
              <div className='service__details-thumb'>
                <Image src={ServicesDetails} alt='image' />
              ...
              <div className='service__details-content'>
                ...
                <p>
                  ...
                  just not an only passion for our Company. We have to a
                  tendency to believe the idea that
                </p>
                ...
                <p>
                  ...
                  websitet in on visitors.Web designing in a powerful way of
                  just not an only profession Web designing in a powerful way of
                  just not an only Web designing in a powerful way of just not
                  an only professions, however, in a passion for our Company. We
                  have to a tendency to believe the idea that smart looking of
                  any websitet in on visitors.Web designing in a powerful way of
