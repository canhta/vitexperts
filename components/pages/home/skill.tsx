          ...
          <div className='row flex-wrap-reverse'>
              ...
              <div className='skill-area__one-left'>
                ...
                <div className='skill-area__one-left-video'>
                  ...
                  <div
                    ...
                    className='video-popup skill-area__one-left-video-play-btn'
                  >
            ...
            <div className='col-xl-6 col-lg-6 col-md-11'>
              <div className='skill-area__one-right'>
                ...
                <p>
                  We believe that the key to success lies in our ability to
                  anticipate change and innovate proactively. By partnering with
                  us, you gain access
                </p>
                <div className='skill-area__one-right-skill-item'>
                  ...
                  <div className='skill-area__one-right-skill-item-inner'>
                    <div
                      className='skill-area__one-right-skill-item-bar'
                      data-width='70'
                    ></div>
                  </div>
                </div>
