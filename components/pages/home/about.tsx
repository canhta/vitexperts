          ...
          <div className='row align-items-center gy-4'>
                  ...
                  <div className='col-xl-6 col-lg-5 col-md-5 col-6'>
                    ...
                    <div className='about__two-left-progressbar'>
                      <div className='about__two-left-progressbar-wrapper'>
                        ...
                        <h4 className='about__two-right-progressbar-title'>
                          Daily Activity
                        </h4>
                      </div>
                    </div>
            ...
            <div className='col-xl-6 col-lg-6'>
              <div className='about__two-content'>
                ...
                <p>
                  These services and features can provide a comprehensive range
                  of offerings to cater to various technological needs of your
                  clients.
                </p>
                ...
                <Link href='/about' className='btn-two'>
