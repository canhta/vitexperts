      ...
      <ul>
        <li className="menu-item-has-children">
          ...
          <ul className="sub-menu" style={activeSubMenu("home")}>
            ...
            <li>
              <Link href="/home-four">Home 04</Link>
            </li>
            <li>
              <Link href="/home-five">Home 05</Link>
            </li>
          </ul>
          <a
          ...
          <ul className="sub-menu" style={activeSubMenu("pages")}>
            ...
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu" style={activeSubMenus("team")}>
                ...
                <li>
                  <Link href="/team-two">Team Style 02</Link>
                </li>
              </ul>
              <a
        ...
        <li className="menu-item-has-children">
          ...
          <ul className="sub-menu" style={activeSubMenu("services")}>
            ...
            <li>
              <Link href="/services/data-analytics">Services Details</Link>
            </li>
          </ul>
          <a
        ...
        <li className="menu-item-has-children">
          ...
          <ul className="sub-menu" style={activeSubMenu("project")}>
            <li>
              <Link href="/showcase/2-columns">2 Columns</Link>
            </li>
            <li>
              <Link href="/showcase/3-columns">3 Columns</Link>
            </li>
            <li>
              <Link href="/showcase/gateway-integration">
                Showcases Details
              </Link>
            </li>
          </ul>
        ...
        <li className="menu-item-has-children">
          ...
          <ul className="sub-menu" style={activeSubMenu("blog")}>
            ...
            <li>
              <Link href="/blog/ux-ui-designing-the-future-web-design">
                Blog Details
              </Link>
            </li>
          </ul>
